...
exports.Then_I_see_search_contains = exports.Then_I_see_search = void 0;
 ...
 */
function Then_I_see_search(search, options) {
...
(0, cypress_cucumber_preprocessor_1.Then)('I see search {string}', Then_I_see_search);
/**
 ...
 */
function Then_I_see_search_contains(search, options) {
    cy.location((0, utils_1.getOptions)(options)).should(function (location) {
        expect(location.search).to.contain(search);
    });
}
exports.Then_I_see_search_contains = Then_I_see_search_contains;
(0, cypress_cucumber_preprocessor_1.Then)('I see search contains {string}', Then_I_see_search_contains);
