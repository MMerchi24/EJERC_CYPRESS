...
exports.Then_I_see_pathname_contains = exports.Then_I_see_pathname = void 0;
 ...
 */
function Then_I_see_pathname(pathname, options) {
    cy.location((0, utils_1.getOptions)(options)).should(function (location) {
        expect(location.pathname).to.equal(pathname);
    });
}
exports.Then_I_see_pathname = Then_I_see_pathname;
(0, cypress_cucumber_preprocessor_1.Then)('I see pathname {string}', Then_I_see_pathname);
/**
 ...
 */
function Then_I_see_pathname_contains(pathname, options) {
    cy.location((0, utils_1.getOptions)(options)).should(function (location) {
        expect(location.pathname).to.contain(pathname);
    });
}
exports.Then_I_see_pathname_contains = Then_I_see_pathname_contains;
(0, cypress_cucumber_preprocessor_1.Then)('I see pathname contains {string}', Then_I_see_pathname_contains);
