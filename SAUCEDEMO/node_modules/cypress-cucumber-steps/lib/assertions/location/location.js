...
exports.Then_I_see_location = void 0;
 ...
 */
function Then_I_see_location(location) {
    var loc = (0, utils_1.getOptions)(location);
    if (typeof (loc === null || loc === void 0 ? void 0 : loc.port) === 'number') {
        loc.port = String(loc.port);
    }
    cy.location().should('include', loc);
}
exports.Then_I_see_location = Then_I_see_location;
(0, cypress_cucumber_preprocessor_1.Then)('I see location', Then_I_see_location);
