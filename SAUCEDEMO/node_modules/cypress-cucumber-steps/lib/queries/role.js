...
exports.When_I_find_element_by_role = exports.When_I_find_elements_by_role = void 0;
 ...
 */
function When_I_find_elements_by_role(role, options) {
    (0, utils_1.setCypressElement)((0, utils_1.getRoleElements)(role, constants_1.PseudoSelector.visible, options));
}
exports.When_I_find_elements_by_role = When_I_find_elements_by_role;
(0, cypress_cucumber_preprocessor_1.When)('I find elements by role {string}', When_I_find_elements_by_role);
/**
 ...
 */
function When_I_find_element_by_role(role, options) {
    (0, utils_1.setCypressElement)((0, utils_1.getRoleElements)(role, constants_1.PseudoSelector.visible, options).first());
}
exports.When_I_find_element_by_role = When_I_find_element_by_role;
(0, cypress_cucumber_preprocessor_1.When)('I find element by role {string}', When_I_find_element_by_role);
